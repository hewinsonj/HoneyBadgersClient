    ...
    <>
      <Form.Group inline floated="left">
        <Container fluid>
          <Form.Field>
            <b>
              <Image size="mini" src={avatars.badger} wrapped />
            </b>
            <Checkbox
              radio
              label="Badger"
        ...
        <Container fluid>
          <Form.Field>
            <b>
              <Image size="mini" src={avatars.giraffe} wrapped />
            </b>
            <Checkbox
              radio
              label="Giraffe"
        ...
        <Container fluid>
          <Form.Field>
            <b>
              <Image size="mini" src={avatars.bear} wrapped />
            </b>
            <Checkbox
              radio
              label="Bear"
        ...
        <Container fluid>
          <Form.Field>
            <b>
              <Image size="mini" src={avatars.raccoon} wrapped />
            </b>
            <Checkbox
              radio
              label="Raccoon"
