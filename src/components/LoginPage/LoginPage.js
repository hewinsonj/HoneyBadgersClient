          ...
          <Grid.Column>
            ...
            >
              <Segment raised verticalAlign="middle" centered>
                <h4>
                  <h3>Honey Badges </h3> is an application where users can keep
                  a running list of activites to complete and earn "badges" for
                  completing multiple activites of the same type. Together,
                  users form a community of badge-earners who can opt to share
                  their accomplishments and use eachother's activities for
                  inspiration. We hope the social aspect of creating and sharing
                  activities will motivate users in a positive way. At the same
                  time, users will have the option to make specific activities
                  on their tasklist private. Users who need some help getting
                  started can also choose to randomly generate an activity
                  ...
                  <Grid.Column width={11}>
                    ...
                    <List size="big">
                      <List.Item>
                        ...
                        <List.Content>
                          <p>Resolve a problem you've been putting off</p>
                        </List.Content>
                      </List.Item>
                      <List.Item>
                        <List.Icon name="edit outline" verticalAlign="bottom" />
                        <List.Content verticalAlign="middle">
                          <p>Organize your dresser</p>
                        </List.Content>
                      </List.Item>
                      <List.Item>
                        <List.Icon name="edit outline" verticalAlign="bottom" />
                ...
                <Segment raised>
                  <Container fluid>
                    <Grid>
                      ...
                      >
                        <h3>
                          <Link to={`/`}>Arthur</Link> is currently working on
                          the{" "}
                          <Link to={`/`}>
                ...
                <Segment raised>
                  <Container fluid>
                    <Grid>
                      ...
                      >
                        <h3>
                          <Link to={`/`}>Trillian</Link> is currently working on
                          the{" "}
                          <Link to={`/`}>Organize your music collection</Link>{" "}
                          activity
                        </h3>
                      </Grid.Column>
                      <Grid.Column
                ...
                <Segment raised>
                  <Container fluid>
                    <Grid>
                      ...
                      >
                        <h3>
                          <Link to={`/`}>Ford</Link> is currently working on the{" "}
                          <Link to={`/`}>Learn how to french braid hair</Link>{" "}
                          activity
                        </h3>
                      </Grid.Column>
                      <Grid.Column
                ...
                <Segment raised>
                  <Container fluid>
                    <Grid>
                      ...
                      >
                        <h3>
                          <Link to={`/`}>Marvin</Link> is currently working on
                          the{" "}
                          <Link to={`/`}>
          ...
          {user ? null : (
            <Grid.Column>
              <Segment raised inverted color="yellow">
                <Header size="huge">Welcome to Honey Badges</Header>
