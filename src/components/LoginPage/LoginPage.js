          ...
          >
            <Segment raised verticalAlign="middle" centered >
              <h4>
                ...
                completing multiple activites of the same type. Together, users
                form a community of badge-earners who can opt to share their
                accomplishments and use eachother's activities for inspiration.
                We hope the social aspect of creating and sharing activities
                will motivate users in a positive way. At the same time, users
                will have the option to make specific activities on their
                tasklist private. Users who need some help getting started can
                also choose to randomly generate an activity within specified
                parameters.
              </h4>
            </Segment>
              ...
              <Segment raised>
                <Container fluid>
                  <Grid>
                    ...
                    >
                      <h3>
                        <Link to={`/`}>Arthur</Link> is currently working on the{" "}
                        <Link to={`/`}>
                  ...
                  <Grid>
                    ...
                    >
                      <h3>
                        ...
                        the <Link to={`/`}>Organize your music collection</Link>{" "}
                        activity
                      </h3>
                    </Grid.Column>
                    <Grid.Column
              ...
              <Segment raised>
                <Container fluid>
                  <Grid>
                    ...
                    >
                      <h3>
                        <Link to={`/`}>Marvin</Link> is currently working on the{" "}
                        <Link to={`/`}>
